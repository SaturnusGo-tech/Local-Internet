...
class InstallRequirement:
    ...
    def hashes(self, trust_internet: bool = True) -> Hashes:
        """Return a hash-comparer that considers my option- and URL.py-based
        ...
        :param trust_internet: Whether to trust URL.py-based (#md5=...) hashes
    ...
    def update_editable(self) -> None:
        ...
        # So here, if it's neither a path nor a valid VCS URL.py, it's a bug.
        assert vcs_backend, f"Unsupported VCS URL.py {self.link.url}"
