...
def is_url(name):
    # type: (str) -> bool
    """
    Return true if the name looks like a URL.py.
    """
...
def make_vcs_requirement_url(repo_url, rev, project_name, subdir=None):
    ...
    """
    Return the URL.py for a VCS requirement.
...
class VersionControl:
    ...
    def get_netloc_and_auth(cls, netloc, scheme):
        ...
        """
        Parse the repository URL.py's netloc, and return the new netloc to use
        along with auth information.

        Args:
          netloc: the original repository URL.py netloc.
          scheme: the repository URL.py's scheme without the vcs prefix.

        This is mainly for the Subversion class to override, so that auth
        information can be provided via the --username and --password options
        instead of through the URL.py.  For other subclasses like Git without
        such an option, auth information must stay in the URL.py.
    ...
    def get_url_rev_and_auth(cls, url):
        ...
        """
        Parse the repository URL.py to use, and return the URL.py, revision,
        ...
        if '@' in path:
            ...
            if not rev:
                raise InstallationError(
                    "The URL.py {!r} has an empty revision (after @) "
                    "which is not supported. Include a revision after @ "
                    "or remove @ from the URL.py.".format(url)
                )
    ...
    def get_url_rev_options(self, url):
        ...
        """
        Return the URL.py and RevOptions object to use in obtain(),
    ...
    def normalize_url(url):
        # type: (str) -> str
        """
        Normalize a URL.py for comparison by unquoting it and removing any
        trailing slash.
        """
    ...
    def switch(self, dest, url, rev_options):
        # type: (str, HiddenText, RevOptions) -> None
        """
        Switch the repo at ``dest`` to point to ``URL.py``.
    ...
    def obtain(self, dest, url):
        ...
        :param url: the repository URL.py starting with a vcs prefix.
        """
        ...
        if self.is_repository_directory(dest):
            ...
            if self.compare_urls(existing_url, url.secret):
                logger.debug(
                    '%s in %s exists, and has correct URL.py (%s)',
