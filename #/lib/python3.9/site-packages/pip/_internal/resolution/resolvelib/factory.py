...
class Factory:
    ...
    def _make_requirement_from_install_req(
        ...
        if cand is None:
            # There's no way we can satisfy a URL.py requirement if the underlying
            # candidate fails to build. An unnamed URL.py must be user-supplied, so
            # we fail eagerly. If the URL.py is named, an unsatisfiable requirement
