...
def get_file_url(
    ...
    # hash in `hashes` matching: a URL.py-based or an option-based
...
class RequirementPreparer:
    ...
    def _get_linked_req_hashes(self, req):
        ...
        # (For example, we can raise VcsHashUnsupported for a VCS URL.py
        ...
        if link.is_existing_dir() and self.in_tree_build:
            ...
            try:
                ...
                raise InstallationError(
                    ...
                    'error {} for URL.py {}'.format(req, exc, link)
                )
        else:
