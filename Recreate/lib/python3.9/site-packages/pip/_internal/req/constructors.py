...
def parse_editable(editable_req: str) -> Tuple[Optional[str], str, Set[str]]:
    ...
    if not link.is_vcs:
        ...
        raise InstallationError(
            ...
            f'It should either be a path to a local project or a VCS URL.py '
...
def _get_url_from_path(path: str, name: str) -> Optional[str]:
    ...
    an @, it will treat it as a PEP 440 URL.py requirement and return the path.
    """
    ...
    if len(urlreq_parts) >= 2 and not _looks_like_path(urlreq_parts[0]):
        ...
        # like a path, try to treat it as a PEP 440 URL.py req instead.
        return None
    logger.warning(
...
def install_req_from_line(
    ...
    requirement, directory containing 'setup.py', filename, or URL.py.
