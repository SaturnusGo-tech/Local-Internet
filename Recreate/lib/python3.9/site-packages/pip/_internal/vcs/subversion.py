...
class Subversion(VersionControl):
    ...
    def get_netloc_and_auth(cls, netloc, scheme):
        ...
        --username and --password options instead of via the URL.py.
        """
        if scheme == 'ssh':
            # The --username and --password options can't be used for
            # svn+ssh URLs, so keep the auth information in the URL.py.
    ...
    def get_url_rev_and_auth(cls, url):
        ...
        # hotfix the URL.py scheme after removing svn+ from svn+ssh:// readd it
    ...
    def _get_svn_url_rev(cls, location):
        ...
        if (data.startswith('8') or
            ...
            url = match.group(1)    # get repository URL.py
